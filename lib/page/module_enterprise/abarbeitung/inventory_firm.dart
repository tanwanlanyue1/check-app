...
///企业清单
class InventoryFirm extends StatefulWidget {
  List hiddenInventory;
  String companyId;
  InventoryFirm({Key? key,required this.hiddenInventory,required this.companyId}) : super(key: key);

  @override
  _InventoryFirmState createState() => _InventoryFirmState();
}

class _InventoryFirmState extends State<InventoryFirm> {
  ...
  @override
  void didUpdateWidget(covariant InventoryFirm oldWidget) {
