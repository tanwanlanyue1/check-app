    ...
    },
    {
      ...
      'arguments':{
        ...
        'data':[
          ...
          {'title':'反应时间','valuer':'reactionTime',"time":true},
    ...
    },
    {
      ...
      'arguments':{
        ...
        'data':[
          ...
          {'title':'排污许可证下发时间','valuer':'licenseDeliveryTime',"time":true},
          {'title':'排污许可证有效期','valuer':'licenseValidTime',"time":true},
          ...
          {'title':'整改时限','valuer':'rectificationDate',"time":true},
    ...
    },
    {
      ...
      'arguments':{
        ...
        'data':[
          ...
          {'title':'编制时间','valuer':'compilationTime',"time":true},
          {'title':'环评报告类型','valuer':'reportType'},
          {'title':'是否有环评批复','valuer':'reply'},
          {'title':'批复单位','valuer':'replyUnit'},
          {'title':'批复日期','valuer':'replyDate',"time":true},
          {'title':'批复文号','valuer':'replyCode'},
          {'title':'投产时间','valuer':'putProductTime',"time":true},
          {'title':'验收时间','valuer':'acceptTime',"time":true},
          {'title':'备注','valuer':'remark'},
        ]
      }
    },
    {
      ...
      'arguments':{
        ...
        'data':[
          ...
          {'title':'安装时间','valuer':'installTime',"time":true},
    ...
    },
    {
      ...
      'arguments':{
        ...
        'data':[
          ...
          {'title':'检测日期','valuer':'detectDate',"time":true},
    ...
    },
    {
      ...
      'arguments':{
        ...
        'data':[
          ...
          {'title':'检测时间','valuer':'detectTime',"time":true},
    ...
    },
    {
      ...
      'arguments':{
        ...
        'data':[
          ...
          {'title':'培训时间','valuer':'trainingDate',"time":true},
          {'title':'本年度是否有开展应急演练','valuer':'startDrill'},
          {'title':'演练时间','valuer':'drillDate',"time":true},
    ...
    },
    {
      ...
      'arguments':{
        ...
        'data':[
          ...
          {'title':'投入使用时间（年月日）','valuer':'useTime',"time":true},
